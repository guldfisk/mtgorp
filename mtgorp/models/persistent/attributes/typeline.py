...
BATTLE = CardType("Battle", is_permanent=True)
...
INFINITY = CardSubType("Infinity", (ARTIFACT,))
JUNK = CardSubType("Junk", (ARTIFACT,))
LANDER = CardSubType("Lander", (ARTIFACT,))
MAP = CardSubType("Map", (ARTIFACT,))
POWERSTONE = CardSubType("Powerstone", (ARTIFACT,))
SPACECRAFT = CardSubType("Spacecraft", (ARTIFACT,))
STONE = CardSubType("Stone", (ARTIFACT,))
...
PLANET = CardSubType("Planet", (LAND,))
POWER_PLANT = CardSubType("Power-Plant", (LAND,))
SPHERE = CardSubType("Sphere", (LAND,))
SWAMP = BasicLandType("Swamp", (LAND,))
TOWER = CardSubType("Tower", (LAND,))
TOWN = CardSubType("Town", (LAND,))
URZA_S = CardSubType("Urza’s", (LAND,))
...
QUINTORIUS = CardSubType("Quintorius", (PLANESWALKER,))
...
OMEN = CardSubType("Omen", (INSTANT, SORCERY))
...
ARMADILLO = CardSubType("Armadillo", (CREATURE, TRIBAL))
...
BEAVER = CardSubType("Beaver", (CREATURE, TRIBAL))
...
BISON = CardSubType("Bison", (CREATURE, TRIBAL))
...
COYOTE = CardSubType("Coyote", (CREATURE, TRIBAL))
...
DRIX = CardSubType("Drix", (CREATURE, TRIBAL))
...
ECHIDNA = CardSubType("Echidna", (CREATURE, TRIBAL))
...
GLIMMER = CardSubType("Glimmer", (CREATURE, TRIBAL))
...
HEDGEHOG = CardSubType("Hedgehog", (CREATURE, TRIBAL))
HELLION = CardSubType("Hellion", (CREATURE, TRIBAL))
HERO = CardSubType("Hero", (CREATURE, TRIBAL))
...
KANGAROO = CardSubType("Kangaroo", (CREATURE, TRIBAL))
...
LEMUR = CardSubType("Lemur", (CREATURE, TRIBAL))
...
LLAMA = CardSubType("Llama", (CREATURE, TRIBAL))
LOBSTER = CardSubType("Lobster", (CREATURE, TRIBAL))
...
MOOGLE = CardSubType("Moogle", (CREATURE, TRIBAL))
MOONFOLK = CardSubType("Moonfolk", (CREATURE, TRIBAL))
MOUNT = CardSubType("Mount", (CREATURE, TRIBAL))
...
PLATYPUS = CardSubType("Platypus", (CREATURE, TRIBAL))
PORCUPINE = CardSubType("Porcupine", (CREATURE, TRIBAL))
POSSUM = CardSubType("Possum", (CREATURE, TRIBAL))
...
QU = CardSubType("Qu", (CREATURE, TRIBAL))
...
SEAL = CardSubType("Seal", (CREATURE, TRIBAL))
...
SYMBIOTE = CardSubType("Symbiote", (CREATURE, TRIBAL))
SYNTH = CardSubType("Synth", (CREATURE, TRIBAL))
...
TIME_LORD = CardSubType("Time Lord", (CREATURE, TRIBAL))
TOY = CardSubType("Toy", (CREATURE, TRIBAL))
...
VARMINT = CardSubType("Varmint", (CREATURE, TRIBAL))
VEDALKEN = CardSubType("Vedalken", (CREATURE, TRIBAL))
VILLAIN = CardSubType("Villain", (CREATURE, TRIBAL))
...
WEASEL = CardSubType("Weasel", (CREATURE, TRIBAL))
...
SIEGE = CardSubType("Siege", (BATTLE,))
